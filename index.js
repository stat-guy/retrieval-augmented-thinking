...
const RAT_TOOL = {
  name: "rat",
  description: "Retrieval Augmented Thinking - Process structured thoughts with metrics, branching, and revision capabilities",
  inputSchema: {
    type: "object",
    properties: {
      thought: {
      ...
      nextThoughtNeeded: {
        type: "boolean",
        description: "Whether another thought is needed to continue the chain"
      },
      thoughtNumber: {
        type: "integer",
      ...
      totalThoughts: {
        type: "integer",
        description: "Total expected thoughts (can be adjusted dynamically)"
      },
      isRevision: {
        type: "boolean",
      ...
      branchFromThought: {
        type: "integer",
        description: "The thought number to branch from (for alternative reasoning paths)"
      },
      branchId: {
        type: "string",
      ...
      needsMoreThoughts: {
        type: "boolean",
        description: "Indicates if the thought process needs extension beyond totalThoughts"
      }
    },
